...
impl CliDriver for NexoraDriver {
    fn metadata(&self) -> DriverMetadata {
        DriverMetadata {
            id: "nexora".to_string(),
            display_name: "Nexora CLI".to_string(),
            executable: "nx".to_string(),
            ...
            launch_strategy: "Nexora command execution".to_string(),
        }
    }

    fn detect(&self) -> Result<bool, DriverError> {
        Ok(crate::drivers::sdk::is_executable_in_path("nx"))
    }
